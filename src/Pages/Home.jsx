...
const BannerSlider = ({ images }) => {
  const bannerImages = images || [
    ...
    'https://res.cloudinary.com/dkrslpxmh/image/upload/v1767693298/WhatsApp_Image_2026-01-06_at_3.17.25_PM_zqlwiv.jpg',
  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-5 mb-4 px-4">
      <div className="relative h-68 rounded-md overflow-hidden shadow-sm bg-gray-800/10">
