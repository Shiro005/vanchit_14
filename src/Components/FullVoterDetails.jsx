          ...
          <div className="p-5">
            ...
            {activeTab === 'details' && (
              <>
                ...
                <DetailRow
                  label="Yadi Bhag Number"
                  value={`${voter.ac1}/${voter.ac2}/${voter.ac3}`}
                />
                ...
                />
                <DetailRow label="WhatsApp Number" value={surveyDynamic.whatsapp || voter.whatsapp} />
                <DetailRow
                  label="Caste"
                ...
                <DetailRow
                  ...
                  value={<TranslatedText>{voter.pollingStationAddress}</TranslatedText>}
                  isFullWidth
                />
                <DetailRow
                  label="Yaadi Bhag / Address"
                  value={<TranslatedText>{voter.yadiBhagAddress}</TranslatedText>}
                  isFullWidth
                />
